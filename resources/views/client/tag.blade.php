                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up" data-aos-delay="200">
                                                    <div class="image-box">
                                                        <a href="product-details-default.html" class="image-link">
                                                            <img src="{{asset('/images/product/default/home-1/default-12.jpg')}}" alt="">
                                                            <img src="{{asset('/images/product/default/home-1/default-3.jpg')}}" alt="">
                                                        </a>
                                                        <div class="action-link">
                                                            <div class="action-link-left">
                                    ...
                                    <div class="tab-pane sort-layout-single" id="layout-list">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    <a href="product-details-default.html" class="product-list-img-link">
                                                        <img class="img-fluid" src="{{asset('/images/product/default/home-1/default-7.jpg')}}" alt="">
                                                        <img class="img-fluid" src="{{asset('/images/product/default/home-1/default-8.jpg')}}" alt="">
                                                    </a>
                                                    <div class="product-list-content">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    <a href="product-details-default.html" class="product-list-img-link">
                                                        <img class="img-fluid" src="{{asset('/images/product/default/home-1/default-9.jpg')}}" alt="">
                                                        <img class="img-fluid" src="{{asset('/images/product/default/home-1/default-10.jpg')}}" alt="">
                                                    </a>
                                                    <div class="product-list-content">
